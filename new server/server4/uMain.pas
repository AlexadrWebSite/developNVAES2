...
begin
 ...
 begin
   ...
   //считываем количество принятых параметров
   ...
   while(Length(s)>1)  do
    ...
    //ищем этот kks в таблице с данными
     ...
     //если нашли то запоминаем его id
      ...
      // logger.Debug('retValue = ' + inttostr(retValue));
       ...
       //если не нашли, то присваеваем ему id = 0
       else
       retValue:=0;
    ...
    //в начало строки добавляем число - количество значений
...
for i:=0 to Params.Count-1 do
  ...
  //добавляем в начало строки количество записей
