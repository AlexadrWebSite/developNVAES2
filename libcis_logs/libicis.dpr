...
begin
   logger.Debug('старт функции insert...');
   ...
   begin
     ...
     begin
          logger.Debug('KKS = '+string(KKS)+' idKKS = ' + IntToStr(idKks));
       //добавление в массив
    ...
    logger.Debug('окончание работы функции insert...');
end;
...
var
  i:integer;
begin
     logger.Debug('старт функции GetFloat...');
    i:=1;
    ...
    GetFloat:=-1;
    logger.Debug('окончание работы функции GetFloat...');
end;
...
begin
  logger.Debug('старт функции GetStatus...');
  GetStatus:=0;
  logger.Debug('окончание работы функции GetStatus...');
end;
